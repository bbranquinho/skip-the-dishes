...
class ProductResourceTest : CommandResourceBaseTest() {
    ...
    fun `Create a product with success`() {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.post("/api/v1/product")
    ...
    fun `Update details for a product`() {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.patch("/api/v1/product/{id}/detail", "d3597b9e-2eeb-11e8-b467-0ed5f89f718b")
    ...
    fun `Update price for a product`() {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.patch("/api/v1/product/{id}/price", "d3597b9e-2eeb-11e8-b467-0ed5f89f718b")
                .content(productDetailContent)
                .contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(MockMvcResultMatchers.status().isOk)
                .andDo(
