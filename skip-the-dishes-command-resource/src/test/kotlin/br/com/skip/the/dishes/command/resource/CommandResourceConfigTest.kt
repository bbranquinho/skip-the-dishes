...
import br.com.skip.the.dishes.domain.order.elements.CreateOrderCommand
...
class CommandResourceConfigTest {
    ...
    private val orderCommandHandler = mock<CommandHandler> {
    ...
    @Bean
    fun orderCommandHandler(): CommandHandler =
            orderCommandHandler
