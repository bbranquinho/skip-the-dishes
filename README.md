...
Based on unitary tests an API documentation based on Spring REST Docs is available in http://relaxed-bartik-5077aa.bitballoon.com/ or in folder *docs/resources/skip-the-dishes-resources.html*.
